            ...
            try {
                if (result != null) {
                    if (result.getInt("success")==1){
                        //Toast.makeText(getApplicationContext(),"Ready to go another activity.",Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(MainActivity.this,AssignmentTasksActivity.class);
